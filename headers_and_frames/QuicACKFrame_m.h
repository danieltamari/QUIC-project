...
#ifndef __INET_QUICACKFRAME_M_H
#define __INET_QUICACKFRAME_M_H
...
/**
 * Struct generated from inet/applications/quicapp/headers_and_frames/QuicACKFrame.msg:28 by nedtool.
 */
...
/**
 * Class generated from <tt>inet/applications/quicapp/headers_and_frames/QuicACKFrame.msg:39</tt> by nedtool.
 * <pre>
 * //
 ...
 * </pre>
 */
class INET_API QuicACKFrame : public ::inet::FieldsChunk
{
  protected:
  ...
  private:
    void copy(const QuicACKFrame& other);

  protected:
    // protected and unimplemented operator==(), to prevent accidental usage
    bool operator==(const QuicACKFrame&);

  public:
    QuicACKFrame();
    QuicACKFrame(const QuicACKFrame& other);
    virtual ~QuicACKFrame();
    QuicACKFrame& operator=(const QuicACKFrame& other);
    virtual QuicACKFrame *dup() const override {return new QuicACKFrame(*this);}
    ...
    virtual range& getACK_rangesForUpdate(size_t k) { handleChange();return const_cast<range&>(const_cast<QuicACKFrame*>(this)->getACK_ranges(k));}
...
inline void doParsimPacking(omnetpp::cCommBuffer *b, const QuicACKFrame& obj) {obj.parsimPack(b);}
inline void doParsimUnpacking(omnetpp::cCommBuffer *b, QuicACKFrame& obj) {obj.parsimUnpack(b);}

} // namespace inet

#endif // ifndef __INET_QUICACKFRAME_M_H
