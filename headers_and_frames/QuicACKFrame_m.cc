//
// Generated file, do not edit! Created by nedtool 5.6 from inet/applications/quicapp/headers_and_frames/QuicACKFrame.msg.
//
...
int QuicACKFrame::getACK_range_count() const
{
    return this->ACK_range_count;
}

void QuicACKFrame::setACK_range_count(int ACK_range_count)
{
    handleChange();
...
size_t QuicACKFrame::getACK_rangesArraySize() const
{
    return ACK_ranges_arraysize;
}

const range& QuicACKFrame::getACK_ranges(size_t k) const
{
...
void QuicACKFrame::setACK_rangesArraySize(size_t newSize)
{
    handleChange();
...
void QuicACKFrame::setACK_ranges(size_t k, const range& ACK_ranges)
{
...
void QuicACKFrame::insertACK_ranges(size_t k, const range& ACK_ranges)
{
    handleChange();
    if (k > ACK_ranges_arraysize) throw omnetpp::cRuntimeError("Array of size  indexed by %lu", (unsigned long)k);
...
void QuicACKFrame::insertACK_ranges(const range& ACK_ranges)
{
    insertACK_ranges(ACK_ranges_arraysize, ACK_ranges);
}

void QuicACKFrame::eraseACK_ranges(size_t k)
{
    if (k >= ACK_ranges_arraysize) throw omnetpp::cRuntimeError("Array of size  indexed by %lu", (unsigned long)k);
    handleChange();
    size_t newSize = ACK_ranges_arraysize - 1;
