...
QuicHandShakeData::QuicHandShakeData() : ::inet::QuicFrame()
{
}

QuicHandShakeData::QuicHandShakeData(const QuicHandShakeData& other) : ::inet::QuicFrame(other)
{
    copy(other);
}
...
QuicHandShakeDataDescriptor::QuicHandShakeDataDescriptor() : omnetpp::cClassDescriptor(omnetpp::opp_typename(typeid(inet::QuicHandShakeData)), "inet::QuicFrame")
{
