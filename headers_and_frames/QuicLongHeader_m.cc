...
int QuicLongHeaderDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0] == 'l' && strcmp(fieldName, "long_packet_type") == 0) return base+0;
    if (fieldName[0] == 'v' && strcmp(fieldName, "version") == 0) return base+1;
    if (fieldName[0] == 's' && strcmp(fieldName, "source_connection_id_length") == 0) return base+2;
    if (fieldName[0] == 's' && strcmp(fieldName, "source_connection_ID") == 0) return base+3;
